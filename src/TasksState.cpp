...
/*                                                                                          */
/********************************************************************************************/
#include "../include/TasksState.hpp" // Include the header file for the Tasks class

// Constructor
TasksState::TasksState(int width, int height, int x, int y) 
...
void TasksState::render(sf::RenderWindow& window) 
{
